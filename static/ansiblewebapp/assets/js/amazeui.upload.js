...
(function($) {
  ...
  AmazeuiUpload.prototype._loadData = function() {
      ...
      this.errorTexts = ["浏览器不支持", "超过最大文件数", "文件大小超过限制,单个文件大小限制为:"+this.maxFileSize+"M", "不允许的上传格式"];
      this.errorCode = {
        200: 'warning',
        201: 'deadly'
  ...
  function alertBox(msg){
    $("#alertbox .am-modal-bd").html("<span class=\"am-icon-warning\"></span> "+msg);
    $('#alertbox').modal({
      relatedTarget: this,
